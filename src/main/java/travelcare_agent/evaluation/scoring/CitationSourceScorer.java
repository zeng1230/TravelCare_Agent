...
public class CitationSourceScorer implements EvaluationScorer {
    ...
    public ScoreResult score(EvaluationScoringContext c){
        ...
        Map<String,Object> expected=new LinkedHashMap<>();expected.put("chunkIds",expectedChunks);expected.put("documentIds",expectedDocuments);expected.put("mustBeEvidence",true);
