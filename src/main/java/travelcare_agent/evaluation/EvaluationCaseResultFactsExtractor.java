...
public class EvaluationCaseResultFactsExtractor {
    ...
    public EvaluationCaseResultFactsExtractor(ObjectMapper json){this.json=json;}
    public EvaluationCaseResultFacts extract(EvaluationCaseResult result){
        String policy="UNKNOWN", workflow="UNKNOWN"; Boolean output=null, safety=null;
        try {
    ...
    private String text(JsonNode n){return n.isMissingNode()||n.isNull()?"UNKNOWN":value(n.asText());}
    private String value(String v){return v==null||v.isBlank()?"UNKNOWN":v;}
}
