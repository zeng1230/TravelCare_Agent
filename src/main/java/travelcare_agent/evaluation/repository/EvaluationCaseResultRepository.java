...
public interface EvaluationCaseResultRepository {
    EvaluationCaseResult save(EvaluationCaseResult value);

    List<EvaluationCaseResult> findResultsByRunId(Long runId);
