...
public class EvaluationRun {
    ...
    private String promptStubVersion;
    ...
    private Integer missingCaseCount;
    ...
    public void setProviderMode(String v) {
        providerMode = v;
    }

    public String getPromptStubVersion() {
        return promptStubVersion;
    }

    public void setPromptStubVersion(String v) {
        promptStubVersion = v;
    }
    ...
    public void setTotalCount(Integer v) {
        totalCount = v;
    }
    ...
    public void setPassedCount(Integer v) {
        passedCount = v;
    }
    ...
    public void setFailedCount(Integer v) {
        failedCount = v;
    }
    ...
    public void setErrorCount(Integer v) {
        errorCount = v;
    }
    ...
    public void setSkippedCount(Integer v) {
        skippedCount = v;
    }
    ...
    public void setRegressionStatus(String v) {
        regressionStatus = v;
    }

    public Integer getRegressionCount() {
        return regressionCount;
    }

    public void setRegressionCount(Integer v) {
        regressionCount = v;
    }
    ...
    public void setImprovedCount(Integer v) {
        improvedCount = v;
    }

    public Integer getNewCaseCount() {
        return newCaseCount;
    }

    public void setNewCaseCount(Integer v) {
        newCaseCount = v;
    }

    public Integer getMissingCaseCount() {
        return missingCaseCount;
    }

    public void setMissingCaseCount(Integer v) {
        missingCaseCount = v;
    }
