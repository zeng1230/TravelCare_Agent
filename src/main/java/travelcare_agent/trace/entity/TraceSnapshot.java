...
@TableName("agent_trace_snapshots")
public class TraceSnapshot {
    ...
    public void setSnapshotType(String v) {
        snapshotType = v;
    }
    ...
    public void setPayloadJson(String v) {
        payloadJson = v;
    }
    ...
    public String getRedactionSummaryJson() {
        return redactionSummaryJson;
    }

    public void setRedactionSummaryJson(String v) {
        redactionSummaryJson = v;
    }
