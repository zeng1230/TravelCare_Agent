...
public class TraceRun {
    ...
    private String traceId; private Long sessionId; private Long workflowId; private Long userId;
    private Long rootInputEventId; private Long rootOutputEventId; private String status;
    private String provider; private String model; private String promptVersion; private Boolean dryRun;
    private LocalDateTime startedAt; private LocalDateTime finishedAt; private Long durationMs;
    private String errorCode; private String errorMessage; private String metadataJson;
    ...
    public Long getWorkflowId(){return workflowId;} public void setWorkflowId(Long v){workflowId=v;}
    public Long getUserId(){return userId;} public void setUserId(Long v){userId=v;}
    public Long getRootInputEventId(){return rootInputEventId;} public void setRootInputEventId(Long v){rootInputEventId=v;}
    public Long getRootOutputEventId(){return rootOutputEventId;} public void setRootOutputEventId(Long v){rootOutputEventId=v;}
    ...
    public Boolean getDryRun(){return dryRun;} public void setDryRun(Boolean v){dryRun=v;}
