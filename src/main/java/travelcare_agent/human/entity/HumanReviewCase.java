package travelcare_agent.human.entity;
...
public class HumanReviewCase {
    ...
    public Long getRefundCaseId() {
        return refundCaseId;
    }

    public void setRefundCaseId(Long refundCaseId) {
    ...
    public HumanReviewCaseStatus getStatus() {
        return status;
    }
